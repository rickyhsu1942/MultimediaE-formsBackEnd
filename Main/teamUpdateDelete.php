...
<script type="text/javascript">
	...
	var loadSqlTeamData = function(page,CommandOrder,CommandKey,CommandValue) {
		$.ajax({
			type:"GET",
			url:"phpfunction/mysqlTeamSelectForSearch.php",
			...
			tableHtml = "<table border=1 style='width:100%'><tr><th>勾選</th><th>單號</th><th>組員名稱</th><th>借用者姓名</th><th>活動名稱</th><th>功能</th></tr>";
 ...
 <div class="main">
	...
	<div class="details">
		<div id="contentTitle" align="center">
			<font style="font-size:20px; font-weight:bold;">器材借用表單(展覽借用組別) - 修改/刪除<font>
		</div><br>
		<div id="search">
