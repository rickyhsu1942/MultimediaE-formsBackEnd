<?php
	...
	if (isset($_GET['sqlCommandLentKind'])) {
		...
		$sqlCommands = " WHERE LEFT(department.formId,1) = '".$sqlCommandLentKind."' AND DATE_ADD(lendDate,INTERVAL deadLine DAY) < CURDATE() AND (returnUndertaker is null OR returnUndertaker='') ";
