...
<script type="text/javascript">
	...
	var loadSqlGeneralData = function(CommandKey,CommandValue) {
		$.ajax({
			...
			if (general.length > 0) {
				...
				submitButton.onclick = function(){UpdateSqlGeneralData()};
	...
	//修改MySQL一般借用表單
	var UpdateSqlGeneralData = function(){
		for (var index in general) {
		...
		$.ajax({
			type:"GET",
			url:"phpfunction/mysqlGeneralUpdate.php",
	...
	<div class="details">
		...
		<div id="content">
			<table align='center' id="contentTable" border=1 style='width:60%'> 
				...
				<tr><th align='right'>系　　所：</th><td align='left'><input type='textfield' id='department' value='' /></td>
					<th align='right'>抵押證件：</th><td align='left'><select id='credentialsSelect'></select></td></tr>
				<tr><th align='right'>學　　號：</th><td align='left'><input type='textfield' id='studentId' value='' /></td>
				<th align='right'>姓　　名：</th><td align='left'><input type='textfield' id='name' value='' /></td></tr>
