...
<script type="text/javascript">
	...
	var loadSqlDepartmentData = function(CommandKey,CommandValue) {
		$.ajax({
			...
			if (department.length > 0) {
				...
				submitButton.onclick = function(){UpdateSqlPropertyDataAndDepartment()};
	...
	//修改MySQL器材型錄資料
	var UpdateSqlPropertyDataAndDepartment = function(){
		...
		for (var index in department) {
			if (document.getElementById("equipmentQuantity" + index).value > department[index].equipmentQuantity){
				alert("裝置歸還數量錯誤!!");
				return;
			}
		}
	...
	<div class="details">
		...
		<div id="content">
			<table align='center' id="contentTable" border=1 style='width:60%'> 
				...
				<tr><th align='right'>借用單位：</th><td align='left'><input disabled type='textfield' id='department' value='' style='border:0px;background:transparent;' /></td>
